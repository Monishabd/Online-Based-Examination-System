...
void startExam()
{
    ...
    // Variables to store user's score and wrong answers
    int score = 0;
    int wrongAnswers = 0;
    ...
    // Check if user wants to start the exam
    char startExam;
    displayInstructions();
    cin >> startExam;
    ...
    for (int i = 0; i < totalQuestions; i++)
    {
        ...
        // Display remaining time and wait for 1 second before clearing the screen for the next question
